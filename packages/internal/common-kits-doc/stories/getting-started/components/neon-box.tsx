...
const StyledHost = styled.div<{ $color: 'brand' | 'purple' }>`
  .cck-theme-storybook-addon__color--dark & {
    --neon-box-bg-effect-start: ${({ $color }) =>
      $color === 'brand' ? 'rgba(18, 123, 86, 0.08)' : 'rgba(58, 129, 191, 0.08)'};
    --neon-box-bg-effect-end: ${({ $color }) =>
      $color === 'brand' ? 'rgba(114, 237, 192, 0.03)' : 'rgba(65, 48, 81, 0.03)'};
    ...
    --neon-box-bg-effect-top: ${({ $color }) =>
      $color === 'brand' ? 'rgba(18, 123, 86, 0.6)' : 'rgba(251, 55, 255, 0.4)'};
    --neon-box-bg-effect-bottom: ${({ $color }) =>
      $color === 'brand' ? 'rgba(114, 237, 192, 0.4)' : 'rgba(24, 178, 222, 0.6)'};
  }

  .cck-theme-storybook-addon__color--light & {
    --neon-box-bg-effect-start: ${({ $color }) =>
      $color === 'brand' ? 'rgba(0, 102, 68, 0.08)' : 'rgba(58, 129, 191, 0.08)'};
    --neon-box-bg-effect-end: ${({ $color }) =>
      $color === 'brand' ? 'rgba(0, 255, 255, 0.03)' : 'rgba(65, 48, 81, 0.03)'};
    ...
    --neon-box-bg-effect-top: ${({ $color }) =>
      $color === 'brand' ? 'rgba(0, 102, 68, 0.6)' : 'rgba(251, 55, 255, 0.4)'};
    --neon-box-bg-effect-bottom: ${({ $color }) =>
      $color === 'brand' ? 'rgba(0, 180, 120, 0.4)' : 'rgba(24, 178, 222, 0.6)'};
  }
