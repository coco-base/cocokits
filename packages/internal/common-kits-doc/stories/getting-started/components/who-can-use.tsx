    ...
    <StyledHost>
      ...
      <StyledNeonBoxGrid>
        <StyledNeonBox color="purple">
          ...
          <StyledNeonBoxList>
            <li>
              Convert Figma Components to Code: Transform your Figma components into popular framework components
              (Angular, React, Vue, or just HTML) without needing to learn any frameworks. You only need to know CSS.
            </li>
            <li>
              Design Package Creation: We provide you with fully functional components in each framework without any
              styles. You can then create your design package (only CSS/SCSS) to style the components and make them
              ready for developers.
            </li>
            <li>
              Support for Existing Design Systems: If you have an existing design system and want to convert it to
              include component code for developers, CocoKits is your best solution.
            </li>
            <li>
              Full Support: We offer comprehensive support during the process with various examples and online sessions
        ...
        <StyledNeonBox color="brand">
          ...
          <StyledNeonBoxList>
            <li>
              Production-Ready Components: CocoKits is ready to be used in your production environment with the core
              components of your favorite design system.
            </li>
            <li>
              Fully Customizable: Depending on your project and requirements, you can easily change the style of any
              component and modify the theme of your design system quickly and effortlessly.
            </li>
            <li>
              Component Examples: All components come with various examples, so you can see how each component looks in
              different scenarios.
            </li>
            <li>
              Override Default Configurations: You can override the default configurations of the components based on
