...
import { SuffixCardPattern } from './SuffixCardPattern';

export const SuffixCardPatternStory: StoryObj<typeof SuffixCardPattern> = {
  ...
  render: (args) => (
    <InlineStyle styles={args.cckExampleCssVariables}>
      <SuffixCardPattern cckExampleArgs={args.cckExampleArgs} />
    </InlineStyle>
  ),
};
