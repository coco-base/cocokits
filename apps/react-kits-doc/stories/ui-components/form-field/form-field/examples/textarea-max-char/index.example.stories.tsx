...
import { TextareaMaxChar } from './TextareaMaxChar';

export const TextareaMaxCharStory: StoryObj<typeof TextareaMaxChar> = {
  ...
  render: (args) => (
    <InlineStyle styles={args.cckExampleCssVariables}>
      <TextareaMaxChar cckExampleArgs={args.cckExampleArgs} />
    </InlineStyle>
  ),
};
