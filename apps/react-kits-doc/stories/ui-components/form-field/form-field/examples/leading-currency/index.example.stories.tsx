...
import { LeadingCurrency } from './LeadingCurrency';

export const LeadingCurrencyStory: StoryObj<typeof LeadingCurrency> = {
  ...
  render: (args) => (
    <InlineStyle styles={args.cckExampleCssVariables}>
      <LeadingCurrency cckExampleArgs={args.cckExampleArgs} />
    </InlineStyle>
  ),
};
