...
import { CheckboxLabelLink } from './CheckboxLabelLink';

export const CheckboxLabelLinkStory: StoryObj<typeof CheckboxLabelLink> = {
  ...
  render: (args) => (
    <InlineStyle styles={args.cckExampleCssVariables}>
      <CheckboxLabelLink cckExampleArgs={args.cckExampleArgs} />
    </InlineStyle>
  ),
};
