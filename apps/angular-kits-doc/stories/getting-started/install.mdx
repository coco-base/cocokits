...
<MdxPageWithThemeSection fn={t => `Install the ${backtick('CocoKits')} Angular components and the ${backtick(t.displayName)} theme`}/>
...
<MdxPageWithThemeSection fn={t => `Here is a list of all collections, modes, and their corresponding CSS selectors for the ${t.displayName} design system:`}/>
