...
<MdxDocTabCode codeTabs={{
  'npm': `npm i @cocokits/angular-components @cocokits/theme-frames-x @cocokits/theme-default`,
  'yarn': `yarn add @cocokits/angular-components @cocokits/theme-frames-x @cocokits/theme-default`,
  'pnpm': `pnpm add @cocokits/angular-components @cocokits/theme-frames-x @cocokits/theme-default`
}}/>
