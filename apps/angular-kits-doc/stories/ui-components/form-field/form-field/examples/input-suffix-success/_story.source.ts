...
import { FormFieldComponent, HintComponent, InputComponent, LabelComponent, SuffixComponent, SvgIconComponent } from '@cocokits/angular-components';
...
@Component({
  ...
  template: \`
    <cck-form-field>
      ...
      @if(isValid()) {
        <cck-suffix>
          <cck-svg-icon [icon]="Icons.checkCircle" [color]="'<%=iconColor%>'" [size]="'<%=iconSize%>'"></cck-svg-icon>
        </cck-suffix>
      }
