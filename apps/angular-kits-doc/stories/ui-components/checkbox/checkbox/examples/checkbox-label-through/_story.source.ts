...
// (Auto generated by the Cocokits 'generate-example-story-source' on Tue Mar 18 2025
...
@Component({
  ...
  template: \` <cck-checkbox [size]="'<%=size%>'" [value]="1"><span class="striked-label"> Checkbox Label </span></cck-checkbox> \`,
  styles: \`
    .striked-label {
