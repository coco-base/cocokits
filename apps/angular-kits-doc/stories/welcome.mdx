...
<MdxDocPage groupTitle='Getting Started'>
  ...
  CocoKits is a professionally crafted toolkit for product design and development teams and individuals. We provide the core components you need for every project, focusing on accessibility, component composition, and development experience.
  ...
  - **Simplified Experience:** Our goal is to make your experience simple and efficient. We handle implementation details like accessibility, flexible architecture, and theming, so you can start building your product immediately.
